...
//
// Authors:
//  Zachary Braffman & Anthony Milas
...
app.get('/compress/:assetid', compress.compress_asset);
app.post('/encrypt/:assetid', encrypt.encrypt_asset);
app.post('/decrypt/:assetid', decrypt.decrypt_asset);
app.post('/color/:assetid', color.change_color);
